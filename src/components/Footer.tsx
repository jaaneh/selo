...
const Footer = () => {
  return (
    <Flex as='footer' flexDir='column' textAlign='center' mb={4}>
      <Text color='brand.fog'>
        What tools would you like to see us build? Let us know{' '}
        <strong>hello@selo.fyi</strong>
      </Text>
